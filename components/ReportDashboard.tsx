...
const ReportTypeModal: React.FC<ReportTypeModalProps> = ({ isOpen, onClose, onSelect }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-white rounded-2xl shadow-2xl p-8 m-4 max-w-md w-full transform transition-all duration-300 scale-100"
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {filteredReports.map((report) => {
                  ...
                  return (
                    <div
                      key={report._id}
                      className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-sm border border-white/50 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 group overflow-hidden relative"
                    >
