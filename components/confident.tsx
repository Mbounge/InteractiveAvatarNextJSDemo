...
const Confidentiality: React.FC<ConfidentialityProps> = ({info, user, selectedLanguage, accessCode, playerData }) => {
  ...
  if (showWelcome) {
    return accessCode === 'kroni' ? <Welcome info={info} user={user} selectedLanguage={selectedLanguage} accessCode={accessCode} playerData={playerData} /> : <Welcome info={info} user={user} selectedLanguage={selectedLanguage} accessCode={accessCode} playerData={playerData} />;
  }
