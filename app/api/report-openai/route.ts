...
export async function POST(request: Request) {
  try {
    ...
    **STYLE AND TERMINOLOGY GUIDE: REFERENCE EXAMPLES**
    ...
    Breakout, forecheck, backcheck, slapshot, wrister, one-timer, deke, faceoff, penalty kill, power play, top six, bottom six, blue line, crease, neutral zone, slot, puck possession, plus-minus, enforcer, grinder, sniper, playmaker, puck drop, hat trick, shutout, rebound, screen, deflection, dump and chase, cycling, puck retrieval, stickhandling, backhand, toe drag, saucer pass, stretch pass, zone entry, line change, shift, checking, body check, poke check, stick check, cross-check, icing, offside, boarding, high-sticking, tripping, hooking, slashing, interference, roughing, instigator, embellishment, five-hole, glove side, blocker side, butterfly, hybrid, crease control, rebound control, save percentage, goals against average, clutch, grinder, hustle, net-front presence, defensive zone coverage, offensive zone pressure, transition game, gap control, stick lift, breakout pass, active stick, shot lane, shot blocking, puck battle, dump-in, pinch, point shot, turnover, takeaway, give-and-go, netminder, crease crash, line rush, power forward, two-way forward, shutdown pair, puck mover, stay-at-home defenseman, quarterback (PP), PK specialist, fourth line, first line, top pair, middle six, net presence, OT winner, puck support, slot coverage, half wall, end boards, zone clear, puck control, faceoff circle, bench minor, major penalty, misconduct, short-handed, man advantage.
    Goal mouth, offensive zone entry, neutral zone trap, backdoor play, stick tape, chirping, board battle, loose puck, puck drop, glass and out, skate save, pad stack, blocker save, glove save, netfront battle, forehand, drop pass, reverse hit, rim around, shoulder check, breakout lane, weak side, strong side, stretch the ice, active feet, headman pass, D-to-D pass, cycle down low, collapsing defense, off the rush, net drive, puck support, puck carrier, lane closure, wall play, point man, trailer, weak-side winger, breakout coverage, net-front screen, puck race, defensive read, offensive instincts, gap closeness, puck flip, neutral zone regroup, forecheck pressure, puck protection, puck separation, wall battle, stick battle, hard rim, chip and chase, high cycle, low-to-high play, slot pass, bumper role, high slot, net crash, stick extension, goalie interference, crease violation, net dislodged, anchor defenseman, inside position, stick lane, off-puck movement, transition defense, ice awareness, puck watching, lateral mobility, defensive stick, shot suppression, scoring chance, primary assist, secondary assist, zone denial, puck advancement, lateral pass, puck luck, zone time, zone pressure, cross-ice pass, puck funnel, wall clear, defensive posture, net presence, forecheck angle.
    Soft dump, glassing the puck, chip-out, weak side breakout, zone collapse, puck regroup, hinge play, controlled entry, controlled exit, uncontrolled entry, net drive lane, dot lane, middle lane drive, seam pass, royal road pass, bumper pass, delay play, trailer option, high flip, puck chip, wheel route, reverse breakout, off-wing, puck cycle, hold the line, zone hold, stick positioning, triangle formation, F1 forechecker, F2 support, F3 high, pressure point, neutral zone clog, back pressure, puck containment, stall tactic, net-front tie-up, stick tie-up, stick lift, box plus one, diamond PK, umbrella PP, overload PP, hinge defense, wall retrieval, D pinch, puck wall, middle drive, low support, backdoor tap-in, slot seam, backside coverage, shot pass, one-touch pass, puck bobble, short side shot, far pad shot, cross-crease feed, rebound chance, net scramble, crease battle, puck dig, shot from the point, off the draw, net-front redirection, neutral zone dump, weak side support, puck carrier delay, late man, defensive layer, puck zone exit, last man back, puck possession time, forced turnover, strip and go, cutback move, ice tilt, puck pressure, slot entry, close support, loose coverage, shot rebound, penalty box, sin bin, garbage goal, tic-tac-toe play, net-front screen assist, weak side lane, high flip breakout, shoulder fake, lane skate, defensive pinch, chip pass, seam collapse, offensive zone rotation.
    Wall pinch, regroup behind net, net-front jam play, cross-slot feed, dangle move, blue line keep-in, delayed penalty, puck chase, zone stretch, breakout delay, high-low cycle, wheel play, blind pass, soft area find, stick blade angle, puck tip, crease invasion, net-front scramble, last line of defense, defensive switch, puck hinge, hinge breakout, seam read, puck stretch, stick wave, puck deflect, top shelf, bottom corner, shot lane denial, stick block, lane interference, puck jam, high slot screen, drive wide, offensive push, defensive collapse, goalie screen, crash and bang, hold the wall, outside lane, cross ice seam, slot seam shot, give-and-go drop, lateral cut, puck slip, delay entry, net-front contest, D-zone rotation, puck bump, turnover creation, neutral zone read, forechecking lane, hard backcheck, defensive close-out, slot tie-up, wall containment, puck float, sneaky release, net cut, pass fake, lane attack, crease jam, crease coverage, weak side switch, puck movement rhythm, board chip, net drive angle, soft wall clear, breakout fake, angle entry, curl and drag, transition turnover, zone shift, board breakout, soft slot pass, tip-in goal, slot crash, late trailer feed, ice stretch, forecheck cycle, puck jump, puck bobble recovery, gap fill, possession support, active stick read, high slot pop-out, zone overload, crease entry, backhand sauce, puck hinge switch, low-to-high rotation, behind-the-net cycle, umbrella rotation, tight turn, corner scrum, stick wedge, puck bat-down, shot tip redirect.
    Hockey IQ, compete level, two-way game, puck skills, skating stride, edgework, lateral mobility, straight-line speed, first-step quickness, four-way mobility, defensive awareness, puck protection, puck retrieval, zone entries, zone exits, transition game, stick positioning, offensive instincts, defensive reads, physicality, net-front presence, shooting mechanics, deception with the puck, puck poise, play-driving ability, in-zone movement, off-puck positioning, forechecking pressure, support game, defensive stick, puck control, spatial awareness, wall play, puck distribution, gap control, shot blocking, active stick, shift-to-shift consistency, effort level, acceleration, agility, mobility, positional awareness, passing touch, offensive zone creation, defensive zone coverage, play reading, shot selection, body positioning, breakout execution, puck management, anticipation, defensive stick detail, escape ability, puck-moving ability, hockey sense, stick detail, shoulder checks, spatial reads, decision-making under pressure.
    Scoring touch, puck touch, skating fluidity, crossovers, transition speed, handling under pressure, change of pace, give-and-go execution, pass reception, deception in transition, puck timing, route timing, inside-driven routes, net-driving instincts, timing layer, slot timing, neutral zone navigation, puck delay mechanics, controlled entries, off-puck timing, shoulder fake, release mechanics, shot versatility, tight-space maneuvering, first-touch control, puck pacing, inside positioning, route discipline, give-and-go touch, shot accuracy, shooting off stride, shot release speed, net-attacking mindset, puck scanning, off-puck movement, play connection, puck funneling, puck advancement skills, underhandling efficiency, scanning habits, crossover acceleration, skating posture, controlled tempo, puck-sharing instincts, support lane usage, possession retention, low-to-high creation, high-slot positioning, defensive lane reads, stick disruption, play-driving shifts, retrieval positioning, outlet passing vision, wall escape, contact balance, puck-sharing timing, half-wall control, inside-lane entries, rotational awareness, pressure evasion, in-tight handling, defensive commitment, puck elevation, pass deception, change-of-direction skill, gap reading, high-pace reads, play extension, curl-and-drag execution, body-check timing.
    Puck management, transition defender, off-puck habits, retrieval skill, play in motion, small-area game, rush defender, scan-and-pass ability, skating mechanics, spatial manipulation, handling in traffic, manipulation skill, delay game, deception tools, route mapping, transition speed, puck touches, possession sequences, neutral zone defender, pass-touch timing, rush offense creator, point-shot threat, breakout facilitator, retrieval timing, defensive scanning, speed through the neutral zone, space attack, in-tight skill, defensive posture, positional detail, pass reception timing, give-and-go touch, pace variation, crossover speed, delayed entry play, physical transition defender, retrieval execution, puck deception, offensive activation, scanning detail, rush activation, net-driving routes, possession carrier, give-and-go routes, pre-touch scanning, dual-threat shooter-passer, controlled entry skill, touch passing, backpressure reads, play anticipation, layered offensive support, spatial awareness tools, offensive zone mobility, shot lane creation, weak-side read, wall retrieval skill, forecheck shoulder check, net attack timing, underhandling pace, high-speed decision making.

    Puck management, transition defender, off-puck habits, retrieval skill, play in motion, small-area game, rush defender, scan-and-pass ability, skating mechanics, spatial manipulation, handling in traffic, manipulation skill, delay game, deception tools, route mapping, transition speed, puck touches, possession sequences, neutral zone defender, pass-touch timing, rush offense creator, point-shot threat, breakout facilitator, retrieval timing, defensive scanning, speed through the neutral zone, space attack, in-tight skill, defensive posture, positional detail, pass reception timing, give-and-go touch, pace variation, crossover speed, delayed entry play, physical transition defender, retrieval execution, puck deception, offensive activation, scanning detail, rush activation, net-driving routes, possession carrier, give-and-go routes, pre-touch scanning, dual-threat shooter-passer, controlled entry skill, touch passing, backpressure reads, play anticipation, layered offensive support, spatial awareness tools, offensive zone mobility, shot lane creation, weak-side read, wall retrieval skill, forecheck shoulder check, net attack timing, underhandling pace, high-speed decision making, shot manipulation, shot-pass threat, retrieval positioning, inside-lane attack, controlled escape, slot driving, puck control pace, high-slot presence, delay mechanic, retrieval angles, puck support routes, puck-dominant style, stick detail, cross-slot creation, neutral-zone agility, deceptive pass weight, off-puck delay, retrieval under pressure.
    Inside-driven attack, slot presence, forecheck pressure, puck skill sequences, offensive zone creation, puck touch weight, puck retrieval routes, pre-scan timing, play extension, retrieval anticipation, skating deception, slot release timing, lateral mobility tools, scan timing, puck-sharing instinct, small-area manipulation, pass deception skill, controlled touch, dynamic handling, puck-protection habits, middle-lane drive, give-and-go timing, crossover agility, net-front timing, puck-distribution vision, deceptive carry, breakout read, in-zone support, stick positioning detail, carry-and-dish ability, high-tempo creation, offensive-layering reads, wall work, high-slot delay, backside entry, puck-winning skill, puck-moving instincts, manipulation reads, outlet-read timing, bump-and-go touch, shooting deception, shot-ready posture, slot-layer attack, stick-check timing, puck-shielding technique, high-speed puck movement, pressure-delay play, zone-transition support, escape-read awareness, offensive-surging reads, in-stride pass touch, pass-lane timing, space-finding ability, retrieval body positioning, turn-and-pass control, puck-rotation awareness, delayed touch release, multi-layer reads, offensive-delay movement, low-support positioning, puck-travel timing.
    High-slot awareness, off-puck rotation, possession-driving habits, retrieval-read efficiency, puck-transfer timing, net-crash instinct, touch-pass execution, slot-layer timing, controlled entry mechanics, zone exit precision, deception under pressure, lane-driving ability, puck-touch deception, puck-sharing rhythm, stick-check disruption, route-timing sharpness, delayed-feed execution, pressure-read agility, off-puck threat, skating-layer manipulation, wall-exit skill, puck-pursuit consistency, breakout-lane read, weakside activation, outlet-timing precision, net-attack pace, stick-pressure control, lateral-shift mobility, touch-read skill, high-tempo passing, delay-route execution, possession-layer movement, cycle-read awareness, offensive-zone switch, pass-lane deception, wall-read timing, reverse-puck control, breakout-support routes, puck-skill under duress, scanning-layer habits, second-effort puck win, support-positioning detail, offensive-push timing, spatial-support activation, shoulder-check habit, in-zone deception, retrieval-timing agility, off-puck lane use, net-front pop-out, wall-play manipulation, puck-possession tempo, support-layer reads, high-skill delay entry, deception-layer passing, in-tight puck control, play-connection timing.
