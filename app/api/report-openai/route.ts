  ...
  try {
    ...
    **STYLE AND TERMINOLOGY GUIDE: REFERENCE EXAMPLES**
    ...
    const userPrompt = `
      ...
      **IMPORTANT:** Your entire response must be only the raw Markdown/HTML of the report, starting with the <h1> tag. STRICTLY DO NOT wrap the output in markdown code blocks (like \`\`\`html or \`\`\`). Do not add any conversational text.
    `;
